...
$message = "";
if(isset($_POST['btnRegister']) && isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirmpassword']))
{ 
	//check if form was submitted
  	//$input = $_POST['email']; //get input text
	//$message = "Success! You entered: ".$input;
	//echo 'Login clicked'.$message;
	// if($_POST['email'] === 'threads.bilal@gmail.com' && $_POST['password'] === '123' && $_POST['password'] === $_POST['confirmpassword'])
	// {
	...
	if (count($errors) == 0) {
		...
		$query = "INSERT INTO users (User_Name, User_Email, User_Password, Role, Date_Created) VALUES('$username', '$email', '$password', 'User', CURDATE())";
		...
		if(mysqli_num_rows($result) >= 1)//You are mixing the mysql and mysqli, change this line of code
		{
			while ($row = $result->fetch_assoc()) {
				...
				//$_SESSION['success'] = "You are now logged in";
				$message = '<div class="vc_column-inner"><div class="wpb_wrapper"><div class="rb_info_box success"><div class="icon_wrapper"><i></i></div><div class="content_wrapper"><p class="h5 info_box_title">Registerd Successfully</p></div></div></div></div>';
	...
	{
		$message = '<div class="vc_column-inner"><div class="wpb_wrapper"><div class="rb_info_box error"><div class="icon_wrapper"><i></i></div><div class="content_wrapper"><p class="h5 info_box_title">Please Use Different Username/Email</p></div></div></div></div>';
	}
} 
?>
<!DOCTYPE html>
...
<head>
	...
	<title>SEO-Tech-Store Register</title>
			...
			<div class='container'>
				<div id="rb_content_5de2285923fa3" class="rb_content_5de2285923fa3 rb-content background_no_hover">
					<div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_custom_1562326619547 vc_row-has-fill vc_row-o-content-middle vc_row-flex">
						...
						<div id='rb_column_5de22859244ab' class='rb_column_wrapper vc_col-sm-2 '>
						...
						<div class="row_hover_effect"></div>
						<div id='rb_column_5de228592484f' class='rb_column_wrapper vc_col-sm-10 '>
						...
						<div class="row_hover_effect"></div>
						<!-- <div id='rb_column_5de228592bd7b' class='rb_column_wrapper vc_col-sm-3 '>
							<div class="wpb_column vc_column_container vc_col-sm-3">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
										<div id='rb_inner_row_5de228592c03c' class='rb_inner_row_wrapper'>
											<div class="vc_row wpb_row vc_inner vc_row-fluid vc_row-o-content-middle vc_row-flex">
												<div id='rb_column_5de228592c27b' class='rb_column_wrapper vc_col-sm-4 '>
													<div class="wpb_column vc_column_container vc_col-sm-4">
														<div class="vc_column-inner vc_custom_1561722795510">
															<div class="wpb_wrapper">
																<div id='rb_search_5de228592c40a' class='rb_search_module'>
												...
												<div id='rb_column_5de228592c489' class='rb_column_wrapper vc_col-sm-8 '>
													<div class="wpb_column vc_column_container vc_col-sm-8">
														<div class="vc_column-inner">
															<div class="wpb_wrapper">
																<div id='rb_button_wrapper_5de228592c5e0' class='rb_button_wrapper '><a id='rb_button_5de228592c617' class='rb_button advanced  default no_shadow' href='contacts.php' target="_blank">Get a Quote</a></div>
															</div>
														</div>
													</div>
												</div>
			...
			<div class='container'>
				...
				<div id="rb_content_5de228592d650" class="rb_content_5de228592d650 rb-content background_no_hover">
					<div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_custom_1571720915789 vc_row-has-fill vc_row-o-content-middle vc_row-flex">
						<div class="row_hover_effect"></div>
						<div id='rb_column_5de228592d787' class='rb_column_wrapper vc_col-sm-2 '>
							<div class="wpb_column vc_column_container vc_col-sm-2">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
						...
						<div class="row_hover_effect"></div>
						<div id='rb_column_5de228592d993' class='rb_column_wrapper vc_col-sm-10 '>
							<div class="wpb_column vc_column_container vc_col-sm-7">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
						...
						<div class="row_hover_effect"></div>
						<!-- <div id='rb_column_5de2285932d7c' class='rb_column_wrapper vc_col-sm-3 '>
							<div class="wpb_column vc_column_container vc_col-sm-3">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
										<div id='rb_inner_row_5de2285932eb2' class='rb_inner_row_wrapper'>
											<div class="vc_row wpb_row vc_inner vc_row-fluid vc_row-o-content-middle vc_row-flex">
												<div id='rb_column_5de2285932fab' class='rb_column_wrapper vc_col-sm-4 '>
													<div class="wpb_column vc_column_container vc_col-sm-4">
														<div class="vc_column-inner vc_custom_1561722795510">
															<div class="wpb_wrapper">
																<div id='rb_search_5de22859330be' class='rb_search_module'>
																	<div class='search-trigger'></div>
																</div>
															</div>
														</div>
												...
												<div id='rb_column_5de2285933140' class='rb_column_wrapper vc_col-sm-8 '>
													<div class="wpb_column vc_column_container vc_col-sm-8">
														<div class="vc_column-inner">
															<div class="wpb_wrapper">
																<div id='rb_button_wrapper_5de2285933250' class='rb_button_wrapper '><a id='rb_button_5de2285933287' class='rb_button advanced  medium no_shadow' href='contacts.php' target="_blank">Get a Quote</a></div>
															</div>
														</div>
													</div>
												</div>
										...
										<div id='rb_title_area_5de228593362b' class='custom page_title_container  mouse_anim scroll_anim shared_bg' style=""><img data-depth='0.80' src='wp-content/uploads/2013/06/title_hexagons.png' class='page_title_dynamic_image' alt='Contacts' />
											<div class='page_title_wrapper'>
												...
												<div class="breadcrumbs">
													<div class="container">
														<nav class="bread-crumbs"><a href="index.php" property="v:title">Home</a><span class='delimiter'></span><span class="current">Register</span></nav><!-- .breadcrumbs -->
													</div>
												</div>
											</div>
										</div>
		...
		<div id="site-header-mobile" class="site-header-mobile">
			<div class="header-content">
				...
				<div class="page_title_container masked" style="">
					...
					<img data-depth="0.80" src="wp-content/uploads/2013/06/title_hexagons.png" class="page_title_dynamic_image" alt="Register" />
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">													
													<div class='rb_textmodule_5de228593c3a5 rb_textmodule align_center'>
														<h3 class='rb_textmodule_title'><strong>Register To Continue</strong><span class='rb_textmodule_divider'></span></h3>
													</div>
													<?php echo $message; ?>
													<div class="wpforms-container wpforms-container-full button_center" id="wpforms-4323">
														<form class="wpforms-validate wpforms-form" method="post" enctype="multipart/form-data" action="Register.php">
															<div class="wpforms-field-container">
																<div class="wpforms-field wpforms-field-text">
																	<input type="text" class="wpforms-field-large wpforms-field-required" name="username" placeholder="Name" required>
																</div>
																<div class="wpforms-field wpforms-field-email">
																	<label class="wpforms-field-label wpforms-label-hide">Email <span class="wpforms-required-label">*</span></label><input type="email" class="wpforms-field-large wpforms-field-required" name="email" placeholder="E-mail" required>
																</div>
																<div class="wpforms-field wpforms-field-password width_50">
																	<input type="password"  class="wpforms-field-large wpforms-field-required" name="password" placeholder="Password" required>
																</div>
																<div class="wpforms-field wpforms-field-password width_50">
																	<input type="password"  class="wpforms-field-large wpforms-field-required" name="confirmpassword" placeholder="Confirm Password" required>
																</div>
																<!-- <div class="wpforms-field wpforms-field-textarea margin_top_70">
																	<textarea id="wpforms-4323-field_10" class="wpforms-field-large" name="wpforms[fields][10]" placeholder="Write your message"></textarea>
																</div> -->
															</div>
															<!-- <div class="wpforms-field wpforms-field-hp"><label for="wpforms-4323-field-hp" class="wpforms-field-label">Email</label><input type="text" name="wpforms[hp]" id="wpforms-4323-field-hp" class="wpforms-field-medium"></div> -->
															<div class="wpforms-submit-container">
																<button type="submit" name="btnRegister" class="wpforms-submit medium rb_button" value="Register">Register</button>
																<!-- <button type="submit" name="wpforms[submit]" class="wpforms-submit medium rb_button" id="wpforms-submit-4323" value="wpforms-submit" aria-live="assertive" data-alt-text="Register..." data-submit-text="Register">Register</button> -->
															</div>
														</form>
													</div> <!-- .wpforms-container -->
													<div class='rb_textmodule_5de228593c3a5 rb_textmodule align_center' style="margin-top:50px;border-top:2px solid #ccc;padding: 50px 0 0 0;">
														<h6 class='rb_textmodule_title'><strong>Already have an account</strong><span class='rb_textmodule_divider'></span></h6>
														<a class="wpforms-submit medium rb_button">Login</a>
													</div>
												</div>
											</div>
										</div>
