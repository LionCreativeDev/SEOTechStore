...
<head>
	...
	<title>SEO-Tech-Store Content Writing</title>
...
========================================================*/
	...
	<link rel="canonical" href="seo-services.php" />
					...
					<div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_row-no-padding">
						...
						<div id='rb_column_5de226dcc4272' class='rb_column_wrapper vc_col-sm-12 '>
							<div class="wpb_column vc_column_container vc_col-sm-12">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
										<div id='rb_title_area_5de226dcc43e9' class='custom page_title_container  mouse_anim scroll_anim shared_bg' style=""><img data-depth='0.80' src='wp-content/uploads/2013/06/title_hexagons.png' class='page_title_dynamic_image' alt='Content Writing' />
											<div class='page_title_wrapper'>
												<div class="page_title_customizer_size">
													<h1 class='page_title'>Content Writing</h1>
												</div><span class='title_divider'></span>
												<div class="breadcrumbs">
													<div class="container">
														<nav class="bread-crumbs"><a href="index.php" property="v:title">Home</a><span class='delimiter'></span><span class="current">Content Writing</span></nav><!-- .breadcrumbs -->
													</div>
												</div>
											</div>
										</div>
		...
		<div id="site-header-mobile" class="site-header-mobile">
			<div class="header-content">
				...
				<div class="page_title_container masked" style="">
					...
					<img data-depth="0.80" src="wp-content/uploads/2013/06/title_hexagons.png" class="page_title_dynamic_image" alt="Content Writing" />
												...
												<div class="wpb_wrapper">
													<div id='rb_image_5de226dcd91ea' class='rb_image_module background_3d' data-max_tilt=10 data-perspective=1000 data-scale=1 data-speed=300>
														<div class="main_image">
															<img src="wp-content/uploads/2019/08/content-writing-3.png" alt="some-alt" />
														</div>
													</div>
												</div>
											</div>
											...
											<div class="vc_column-inner vc_custom_1565592487743">
												<div class="wpb_wrapper">
													<div class='rb_textmodule_5de226dcd958e rb_textmodule align_left mobile_align_center'>
														...
														<?php if(htmlspecialchars(urldecode($_GET["sub-category"])) == 'Content Writing'){ ?>
														<p>With a thoughtful blend of SEO content, enticing headlines and gripping content, your future clients will be overwhelmed with the urge to learn more about you. Article writing is an exacting science that demands the expertise of highly qualified and dedicated writers. Writers who guarantee microscopic attention to the tiniest details in order to ensure that you build a credible reputation for your business</p>
														<?php } elseif(htmlspecialchars(urldecode($_GET["sub-category"])) == 'Essay Writing'){ ?>															
														<p>Let it now be the past as we are here to provide you with the best writing services. Writing is the sole need of every student; either in homework assigned or professional career one cannot neglect the importance of quality writing. Our platform is especially for the students who suffer in their academic career because of incomplete and insufficiently researched essays.</p>
														<?php } ?>
														</div>
												...
												<div class="wpb_wrapper">
													...
													<div class='rb_inner_row_wrapper'>
														<div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1571303645647">
															<?php
															include_once('business/DB.php');
															$sql = "SELECT * FROM `services` where Category_ID=(select Category_ID from category where Category_Name='Content Writing') and SubCategory_ID=(select SubCategory_ID from sub_category where SubCategory_Name='" . htmlspecialchars(urldecode($_GET["sub-category"])) . "')";
															$result = $conn->query($sql);
