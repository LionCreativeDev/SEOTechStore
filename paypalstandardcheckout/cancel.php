...
$message = '<div class="vc_column-inner"><div class="wpb_wrapper"><div class="rb_info_box info"><div class="icon_wrapper"><i></i></div><div class="content_wrapper"><p class="h5 info_box_title">Cancelled Payment! Feel Free To Contact Us</p></div></div></div></div>.';
										...
										<div id='rb_title_area_5de228593362b' class='custom page_title_container  mouse_anim scroll_anim shared_bg' style=""><img data-depth='0.80' src='../wp-content/uploads/2013/06/title_hexagons.png' class='page_title_dynamic_image' alt='Contacts' />
											<div class='page_title_wrapper'>
												<div class="page_title_customizer_size">
													<h1 class='page_title'>Cancel Payment</h1>
												</div><span class='title_divider'></span>
												<div class="breadcrumbs">
													<div class="container">
														<nav class="bread-crumbs"><a href="index.php" property="v:title">Home</a><span class='delimiter'></span><span class="current">Cancel Payment</span></nav><!-- .breadcrumbs -->
													</div>
												</div>
											</div>
										</div>
		...
		<div id="site-header-mobile" class="site-header-mobile">
			<div class="header-content">
				...
				<div class="page_title_container masked" style="">
					...
					<img data-depth="0.80" src="../wp-content/uploads/2013/06/title_hexagons.png" class="page_title_dynamic_image" alt="Cancel Payment" />
