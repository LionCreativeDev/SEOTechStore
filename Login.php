...
$message = "";
if(isset($_POST['btnLogin']) && isset($_POST['email']) && isset($_POST['password']))
{ 
	//check if form was submitted
  	//$input = $_POST['email']; //get input text
	//$message = "Success! You entered: ".$input;
	//echo 'Login clicked'.$message;
	// if($_POST['email'] === 'threads.bilal@gmail.com' && $_POST['password'] === '123')
	// {
	...
	if(mysqli_num_rows($result) >= 1)
	{
		while ($row = $result->fetch_assoc()) {			
			...
			$message = '<div class="vc_column-inner"><div class="wpb_wrapper"><div class="rb_info_box success"><div class="icon_wrapper"><i></i></div><div class="content_wrapper"><p class="h5 info_box_title">Login Successfully!</p></div></div></div></div>';
			header( "refresh:3;url=index.php" );
		}		
	}
	else
	{
		$message = '<div class="vc_column-inner"><div class="wpb_wrapper"><div class="rb_info_box error"><div class="icon_wrapper"><i></i></div><div class="content_wrapper"><p class="h5 info_box_title">Invalid Email Or Password!</p></div></div></div></div>';
	}
} 
?>
<!DOCTYPE html>
...
<head>
	...
	<title>SEO-Tech-Store Login</title>
										...
										<div id='rb_title_area_5de228593362b' class='custom page_title_container  mouse_anim scroll_anim shared_bg' style=""><img data-depth='0.80' src='wp-content/uploads/2013/06/title_hexagons.png' class='page_title_dynamic_image' alt='Contacts' />
											<div class='page_title_wrapper'>
												...
												<div class="breadcrumbs">
													<div class="container">
														<nav class="bread-crumbs"><a href="index.php" property="v:title">Home</a><span class='delimiter'></span><span class="current">Login</span></nav><!-- .breadcrumbs -->
													</div>
												</div>
											</div>
										</div>
		...
		<div id="site-header-mobile" class="site-header-mobile">
			<div class="header-content">
				...
				<div class="page_title_container masked" style="">
					...
					<img data-depth="0.80" src="wp-content/uploads/2013/06/title_hexagons.png" class="page_title_dynamic_image" alt="Login" />
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">													
													<div class='rb_textmodule_5de228593c3a5 rb_textmodule align_center'>
														<h3 class='rb_textmodule_title'><strong>Login To Continue</strong><span class='rb_textmodule_divider'></span></h3>
													</div>
													<?php echo $message; ?>
													<div class="wpforms-container wpforms-container-full button_center" id="wpforms-4323">
														<form class="wpforms-validate wpforms-form" method="post" enctype="multipart/form-data" action="Login.php">
															<div class="wpforms-field-container">															
																...
																<!-- <div id="wpforms-4323-field_10-container" class="wpforms-field wpforms-field-textarea margin_top_70" data-field-id="10">
															...
															<!-- <div class="wpforms-field wpforms-field-hp">
																<label for="wpforms-4323-field-hp" class="wpforms-field-label">Email</label><input type="text" name="wpforms[hp]" id="wpforms-4323-field-hp" class="wpforms-field-medium">
															</div> -->
															<div class="wpforms-submit-container">
																<button type="submit" name="btnLogin" class="wpforms-submit medium rb_button" value="Login">Login</button>
													...
													<div class='rb_textmodule_5de228593c3a5 rb_textmodule align_center' style="margin-top:50px;border-top:2px solid #ccc;padding: 50px 0 0 0;">
														<h6 class='rb_textmodule_title'><strong>Don't have an account</strong><span class='rb_textmodule_divider'></span></h6>
														<a class="wpforms-submit medium rb_button">Register</a>
													</div>
												</div>
											</div>
										</div>
