...
<head>
	...
	<title>SEO-Tech-Store Cart</title>
					...
					<div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_row-no-padding">
						...
						<div id='rb_column_5de2283e26f7f' class='rb_column_wrapper vc_col-sm-12 '>
							<div class="wpb_column vc_column_container vc_col-sm-12">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
										<div id='rb_title_area_5de2283e271ba' class='custom page_title_container  mouse_anim scroll_anim shared_bg' style=""><img data-depth='0.80' src='wp-content/uploads/2013/06/title_hexagons.png' class='page_title_dynamic_image' alt='Cart' />
											<div class='page_title_wrapper'>
												...
												<div class="breadcrumbs">
													<div class="container">
														<nav class="bread-crumbs"><a href="index.php" property="v:title">Home</a><span class='delimiter'></span><span class="current">Cart</span></nav><!-- .breadcrumbs -->
													</div>
												</div>
											</div>
										</div>
		...
		<div id="site-header-mobile" class="site-header-mobile">
			<div class="header-content">
				...
				<div class="page_title_container masked" style="">
					...
					<img data-depth="0.80" src="wp-content/uploads/2013/06/title_hexagons.png" class="page_title_dynamic_image" alt="Cart" />
								...
								<div class="woocommerce-cart-form">
									<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
										...
										<tbody>
											...
											?>
													<tr class="woocommerce-cart-form__cart-item cart_item">
														<td class="product-remove">
															<a href="business/functions.php?action=RemoveFromCart&Service_ID=<?php echo $row["Service_ID"] ?>" class="remove">×</a> </td>
														...
														<td class="product-subtotal" data-title="Price">
															...
															<td class="product-subtotal"><?php echo date('D, d M Y',strtotime($row["Date"])); ?></td>
											...
											<!-- <tr class="woocommerce-cart-form__cart-item cart_item">
												<td class="product-remove">
													<a href="https://seoes.rainbow-themes.net/cart/?remove_item=fea9c11c4ad9a395a636ed944a28b51a&amp;_wpnonce=9edc4fa77d" class="remove" aria-label="Remove this item" data-product_id="2206" data-product_sku="">×</a> </td>
												<td class="product-thumbnail">
													<a href="https://seoes.rainbow-themes.net/product/woo-album-1/"><img width="570" height="570" src="https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/7-570x570.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="some-alt" srcset="https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/7-570x570.jpg 570w, https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/7-150x150.jpg 150w, https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/7-100x100.jpg 100w" sizes="(max-width: 570px) 100vw, 570px"></a> </td>
												<td class="product-name" data-title="Product">
													<a href="https://seoes.rainbow-themes.net/product/woo-album-1/">Seo Made Simple</a> </td>
											...
											<tr class="woocommerce-cart-form__cart-item cart_item">
												<td class="product-remove">
													<a href="https://seoes.rainbow-themes.net/cart/?remove_item=1c6a0198177bfcc9bd93f6aab94aad3c&amp;_wpnonce=9edc4fa77d" class="remove" aria-label="Remove this item" data-product_id="2189" data-product_sku="">×</a> </td>
												<td class="product-thumbnail">
													<a href="https://seoes.rainbow-themes.net/product/woo-ninja/"><img width="570" height="570" src="https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/1-570x570.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="some-alt" srcset="https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/1-570x570.jpg 570w, https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/1-150x150.jpg 150w, https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/1-100x100.jpg 100w" sizes="(max-width: 570px) 100vw, 570px"></a> </td>
												<td class="product-name" data-title="Product">
													<a href="https://seoes.rainbow-themes.net/product/woo-ninja/">Seo Fitness Workbook</a> </td>
												<td class="product-price" data-title="Price">
													<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>231.00</span> </td>
												<td class="product-quantity" data-title="Quantity">
													<div class="quantity">
														<label class="screen-reader-text" for="quantity_5df122150a677">Seo Fitness Workbook quantity</label>
														<input type="number" id="quantity_5df122150a677" class="input-text qty text" step="1" min="0" max="" name="cart[1c6a0198177bfcc9bd93f6aab94aad3c][qty]" value="1" title="Qty" size="4" inputmode="numeric">
													</div>
												</td>
												<td class="product-subtotal" data-title="Subtotal">
													<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>231.00</span> </td>
											...
											<tr class="woocommerce-cart-form__cart-item cart_item">
												<td class="product-remove">
													<a href="https://seoes.rainbow-themes.net/cart/?remove_item=4aecfbe5d21e3f7912bf8eb29124423a&amp;_wpnonce=9edc4fa77d" class="remove" aria-label="Remove this item" data-product_id="2207" data-product_sku="">×</a> </td>
												<td class="product-thumbnail">
													<a href="https://seoes.rainbow-themes.net/product/woo-album-2/"><img width="570" height="570" src="https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/8-570x570.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="some-alt" srcset="https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/8-570x570.jpg 570w, https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/8-150x150.jpg 150w, https://seoes.rainbow-themes.net/wp-content/uploads/2013/06/8-100x100.jpg 100w" sizes="(max-width: 570px) 100vw, 570px"></a> </td>
												<td class="product-name" data-title="Product">
													<a href="https://seoes.rainbow-themes.net/product/woo-album-2/">The Art of SEO</a> </td>
												<td class="product-price" data-title="Price">
													<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>248.00</span> </td>
												<td class="product-quantity" data-title="Quantity">
													<div class="quantity">
														<label class="screen-reader-text" for="quantity_5df122150a928">The Art of SEO quantity</label>
														<input type="number" id="quantity_5df122150a928" class="input-text qty text" step="1" min="0" max="" name="cart[4aecfbe5d21e3f7912bf8eb29124423a][qty]" value="1" title="Qty" size="4" inputmode="numeric">
													</div>
												</td>
												<td class="product-subtotal" data-title="Subtotal">
													<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$</span>248.00</span> </td>
									...
									<div class="cart_totals ">
										...
										<div class="wc-proceed-to-checkout">
											<!-- <form class="wpforms-validate wpforms-form" method="post" enctype="multipart/form-data" action="business/checkoutpaypal.php">
												<button type="submit" name="btnCheckout" class="checkout-button button alt wc-forward" value="checkout">Proceed to checkout</button>
												<a href="https://seoes.rainbow-themes.net/checkout/" class="checkout-button button alt wc-forward">Proceed to checkout</a>
											</form> -->
											<?php 
											...
											if($enablepaypalstandardbutton == 1)
											{
											?>
											<form class="wpforms-validate wpforms-form" method="post" enctype="multipart/form-data" action="paypalstandardcheckout/checkoutpaypal.php">
												<input type="hidden" value="<?php echo implode(",",$Cart_IDs); ?>" name="Cart_IDs">
												<input type="hidden" value="<?php echo $carttotal; ?>" name="Payment_Amount">
												<button type="submit" name="btnCheckout" class="checkout-button button alt wc-forward" value="checkout">Proceed to checkout</button>
												<!-- <a href="https://seoes.rainbow-themes.net/checkout/" class="checkout-button button alt wc-forward">Proceed to checkout</a> -->
											</form>
											<br/>
											...
											if($enablepaypalexpressbutton==1)
											{
											?>
											<form class="wpforms-validate wpforms-form" method="post" enctype="multipart/form-data" action="paypalexpresss/expresscheckout.php">
												<input type="hidden" value="<?php echo implode(",",$Cart_IDs); ?>" name="Cart_IDs">
												<input type="hidden" value="<?php echo $carttotal; ?>" name="Payment_Amount">
												<button type="submit" name="btnCheckout" class="checkout-button button alt wc-forward" value="checkout">Proceed to checkout</button>												
											</form>
