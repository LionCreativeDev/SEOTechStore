...
<form action='order_confirm.php' METHOD='POST'>
	...
	<input type="submit" name="btnReview" value="Review"/>
</form> -->
<!DOCTYPE html>
...
<head>
	...
	<title>Confirm your informations</title>
										...
										<div id='rb_title_area_5de228593362b' class='custom page_title_container  mouse_anim scroll_anim shared_bg' style=""><img data-depth='0.80' src='../wp-content/uploads/2013/06/title_hexagons.png' class='page_title_dynamic_image' alt='Contacts' />
											<div class='page_title_wrapper'>
												<div class="page_title_customizer_size">
													<h1 class='page_title'>Confirm your informations</h1>
												</div><span class='title_divider'></span>
												<div class="breadcrumbs">
													<div class="container">
														<nav class="bread-crumbs"><a href="index.php" property="v:title">Home</a><span class='delimiter'></span><span class="current">Confirm your informations</span></nav><!-- .breadcrumbs -->
													</div>
												</div>
											</div>
										</div>
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">													
													<div class='rb_textmodule_5de228593c3a5 rb_textmodule align_center'>
														<h3 class='rb_textmodule_title'><strong>Confirm your informations</strong><span class='rb_textmodule_divider'></span></h3>
													</div>
													<?php
													if(isset($_SESSION["userid"]))
													{
														...
														if ($result->num_rows > 0) {
															while ($row = $result->fetch_assoc()) {
																echo '<div class="vc_column-inner"><div class="wpb_wrapper"><div class="rb_info_box success"><div class="icon_wrapper"><i></i></div><div class="content_wrapper"><p class="h5 info_box_title">'.$row["Service_Name"].' ($'.$row["Service_Price"].') </p></div></div></div></div><br/>';
																//echo '<div class="vc_column-inner"><div class="wpb_wrapper"><div class="rb_info_box info"><div class="icon_wrapper"><i></i></div><div class="content_wrapper"><p class="h5 info_box_title">'.$row["Service_Name"].' ($'.$row["Service_Name"].') </p></div></div></div></div>';
															}
														}
													}
													?>
													<div class="wpforms-container wpforms-container-full button_center" id="wpforms-4323">
														<form class="wpforms-validate wpforms-form" method="post" enctype="multipart/form-data" action="order_confirm.php">
															<div class="wpforms-field-container">															
																<div class="wpforms-field wpforms-field-email">
																	<label class="wpforms-field-label wpforms-label-hide">Name <span class="wpforms-required-label">*</span></label><input type="text" class="wpforms-field-large wpforms-field-required" value="<?php echo $lastName." ".$firstName; ?>" readonly>
																</div>
																<div class="wpforms-field wpforms-field-email">
																	<label class="wpforms-field-label wpforms-label-hide">Email <span class="wpforms-required-label">*</span></label><input type="text" class="wpforms-field-large wpforms-field-required" value="<?php echo $email; ?>" readonly>
																</div>
																<div class="wpforms-field wpforms-field-text">
																	<input type="number" class="wpforms-field-large wpforms-field-required" placeholder="amount" value="<?php echo $_SESSION["Payment_Amount"]; ?>" readonly>
																</div>
															</div>
															<div class="wpforms-submit-container">
																<input type="hidden" name="token" value="<?php echo $token; ?>"/>
																<button type="submit" name="btnReview" class="wpforms-submit medium rb_button" value="Review">Confirm</button>
															</div>
														</form>
													</div>
												</div>
