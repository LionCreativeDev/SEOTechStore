                ...
                <section id="content">
                    <section class="vbox">
                        <section class="scrollable padder">
                            <div class="m-b-md">
                                <h3 class="m-b-none">Orders</h3>
                            </div>
                            <section class="panel panel-success">
                                <header class="panel-heading">Orders <i class="fa fa-info-sign text-muted" data-toggle="tooltip" data-placement="bottom" data-title="ajax to load the data."></i>
                                </header>
                                <div class="table-responsive">
                                    <table class="table table-striped m-b-none" data-ride="datatables">
                                        ...
                                        <?php
                                            ...
                                            $sql = "SELECT *,(select Service_Name from services where Service_ID=orders.Service_ID) as 'Service_Name', (select Service_Price from services where Service_ID=orders.Service_ID) as 'Service_Price', (Select Category_Name from category where Category_ID = (SELECT Category_ID FROM `services` WHERE Service_ID=orders.Service_ID)) as 'Category_Name' FROM `orders` where User_ID='2'";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date('D, d M Y',strtotime($row["Order_Date"])); ?></td>
                                                <td>File</th>
                                            </tr>
