...
//$_SESSION["role"] = "Super Admin"; //for testing
//$_SESSION['username'] = "Ahsan";
...
$sql = "SELECT (SELECT Count(*) FROM `visitor_tracker`) as 'visitors', (SELECT Count(*) FROM `users` where role = 'user') as 'users', (SELECT Count(*) FROM `orders`) as 'orders', (SELECT Count(*) FROM `services`) as 'services'";
...
<!-- Mirrored from flatfull.com/themes/scale/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 May 2018 06:33:45 GMT -->
<head>
    <meta charset="utf-8" />
                                ...
                                <section class="scrollable padder">
                                    <section class="row m-b-md">
                                        <div class="col-sm-12">
                                            ...
                                            <small>Welcome back, <?php echo $_SESSION['username']; ?>, <!--<i class="fa fa-map-marker fa-lg text-primary"></i> New York City--></small>
                                        </div>
                                            ...
                                            <div class="panel b-a">
                                                <div class="row m-n">
                                                    <div class="col-md-3 b-b b-r">
                                                        <a href="#" class="block padder-v hover"> <span class="i-s i-s-2x pull-left m-r-sm"> <i class="i i-hexagon2 i-s-base text-danger hover-rotate"></i> <i class="i i-plus2 i-1x text-white"></i> </span> <span class="clear"> <span class="h3 block m-t-xs text-danger"><?php echo $visitors; ?></span> <small class="text-muted text-u-c">Visits</small> </span> </a>
                                                    </div>
                                                    <div class="col-md-3 b-b">
                                                        <a href="#" class="block padder-v hover"> <span class="i-s i-s-2x pull-left m-r-sm"> <i class="i i-hexagon2 i-s-base text-success-lt hover-rotate"></i> <i class="i i-users2 i-sm text-white"></i> </span> <span class="clear"> <span class="h3 block m-t-xs text-success"><?php echo $users; ?></span> <small class="text-muted text-u-c">Users</small> </span> </a>
                                                    </div>
                                                    <div class="col-md-3 b-b b-r">
                                                        <a href="#" class="block padder-v hover"> <span class="i-s i-s-2x pull-left m-r-sm"> <i class="i i-hexagon2 i-s-base text-info hover-rotate"></i> <i class="i i-stack i-sm text-white"></i> </span> <span class="clear"> <span class="h3 block m-t-xs text-info"><?php echo $orders; ?> </span> <small class="text-muted text-u-c">Orderes</small> </span> </a>
                                                    </div>
                                                    <div class="col-md-3 b-b">
                                                        <a href="#" class="block padder-v hover"> <span class="i-s i-s-2x pull-left m-r-sm"> <i class="i i-hexagon2 i-s-base text-primary hover-rotate"></i> <i class="fa fa-tasks i-sm text-white"></i> </span> <span class="clear"> <span class="h3 block m-t-xs text-primary"><?php echo $services; ?></span> <small class="text-muted text-u-c">Services</small> </span> </a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 dker">
                                            <section>
                                                ...
                                                <div class="row text-center no-gutter">
                                                    <div class="col-xs-3">
                                                        <span class="h4 font-bold m-t block"><?php echo $visitors; ?></span>
                                                        <small class="text-muted m-b block">Visitors</small>
                                                    </div>
                                                    <div class="col-xs-3">
                                                        <span class="h4 font-bold m-t block"><?php echo $users; ?></span>
                                                        <small class="text-muted m-b block">Users</small>
                                                    </div>
                                                    <div class="col-xs-3">
                                                        <span class="h4 font-bold m-t block"><?php echo $orders; ?></span>
                                                        <small class="text-muted m-b block">Orders</small>
                                                    </div>
                                                    <div class="col-xs-3">
                                                        <span class="h4 font-bold m-t block"><?php echo $services; ?></span>
                                                        <small class="text-muted m-b block">Services</small>
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                            ...
                                            <section class="panel b-a">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="m-b">
                                                        ...
                                                        <a href="#" class="avatar thumb-sm"> <img src="images/a3.png" alt="..."> <i class="off b-white"></i> </a>
                                        ...
                                        <div class="col-md-4">
                                            <section class="panel b-a">
                                                ...
                                                <ul class="list-group list-group-lg no-bg auto">
                                                    <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="images/a4.png" alt="..."> <i class="on b-white bottom"></i> </span> <span class="clear"> <span>Chris Fox</span> <small class="text-muted clear text-ellipsis">What's up, buddy</small> </span> </a>
                                                    <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="images/a5.png" alt="..."> <i class="on b-white bottom"></i> </span> <span class="clear"> <span>Amanda Conlan</span> <small class="text-muted clear text-ellipsis">Come online and we need talk about the plans that we have discussed</small> </span> </a>
                                                    <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="images/a6.png" alt="..."> <i class="busy b-white bottom"></i> </span> <span class="clear"> <span>Dan Doorack</span> <small class="text-muted clear text-ellipsis">Hey, Some good news</small> </span> </a>
                                                    <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="images/a7.png" alt="..."> <i class="away b-white bottom"></i> </span> <span class="clear"> <span>Lauren Taylor</span> <small class="text-muted clear text-ellipsis">Nice to talk with you.</small> </span> </a>
                                                </ul>
                                                <div class="clearfix panel-footer">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control input-sm btn-rounded" placeholder="Search">
                                                        <span class="input-group-btn"> <button type="submit" class="btn btn-default btn-sm btn-rounded"><i class="fa fa-search"></i></button> </span>
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                ...
                                <section class="scrollable">
                                    ...
                                    <ul class="list-group no-bg no-borders auto">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <span class="clear"> <a href="#"><strong>Admin</strong></a> post a info <small class="icon-muted">1 day ago</small> </span>
                                        </li>
                                    </ul>
                                    <div class="wrapper">
...
//   ]
        <?php
            include_once('../business/DB.php');
            $sql = "SELECT y, m, Count(users.Date_Created) as 'UserCount' FROM ( SELECT y, m FROM (SELECT YEAR(CURDATE()) y UNION ALL SELECT YEAR(CURDATE())-1) years, (SELECT 1 m UNION ALL SELECT 2 UNION ALL SELECT 3 UNION ALL SELECT 4 UNION ALL SELECT 5 UNION ALL SELECT 6 UNION ALL SELECT 7 UNION ALL SELECT 8 UNION ALL SELECT 9 UNION ALL SELECT 10 UNION ALL SELECT 11 UNION ALL SELECT 12) months) ym LEFT JOIN users ON ym.y = YEAR(users.Date_Created) AND ym.m = MONTH(users.Date_Created) WHERE users.Role = 'User' and (y=YEAR(CURDATE()) AND m<=MONTH(CURDATE())) OR (y<YEAR(CURDATE()) AND m>MONTH(CURDATE())) GROUP BY y, m";
            $result = $conn->query($sql);
            ...
            if ($rows > 0) {
                ...
                echo 'var da = [';
                while ($row = $result->fetch_assoc()) {
                    //echo 'd1.push(['.$temp.', '.$row['UserCount'].']);';
                    echo '{label: "'.date("F", mktime(0, 0, 0, $row['m'], 10)).'", data: '.$row['UserCount'].'},';
                    $temp++;
                }
                echo '];';
            }
...
<!-- Mirrored from flatfull.com/themes/scale/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 May 2018 06:34:10 GMT -->
</html>