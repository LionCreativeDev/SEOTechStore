...
$message = "";
if(isset($_POST['btnAddClient']) && isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirmpassword']))
{
...
elseif(isset($_POST["delete"]) && isset($_POST["userid"]) && isset($_POST["username"]) && isset($_POST["useremail"]))
{
    ...
    $query = "SELECT * FROM users WHERE User_ID = '".$userid."' and User_Name='".$username."' and User_Email = '".$useremail."' and role='User' limit 1;";
    $result = mysqli_query($conn,$query);
    
    if(mysqli_num_rows($result) >= 1)//You are mixing the mysql and mysqli, change this line of code
    {
        $query = "Delete FROM users WHERE User_ID = '".$userid."' and User_Name='".$username."' and User_Email = '".$useremail."' and role='User' limit 1;";
        $result = mysqli_query($conn,$query);
                ...
                <section id="content">
                    <section class="vbox">
                        <section class="scrollable padder">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <section class="panel panel-success">
                                        <header class="panel-heading font-bold">Add Client</header>
                                        <div class="panel-body">
                                            <form method="post" enctype="multipart/form-data" action="clients.php">
                                                <div class="form-group"> 
                                                    <label>Client Name</label> <input name="username" type="text" class="form-control" placeholder="John Doe" required> 
                                                </div>
                                                <div class="form-group"> 
                                                    <label>Client Email</label> <input name="email" type="email" class="form-control" placeholder="Enter email" required> 
                                                </div>
                                                <div class="form-group"> 
                                                    <label>Client Password</label> <input name="password" type="password" class="form-control" placeholder="Password" required> 
                                                </div>
                                                <div class="form-group"> 
                                                ...
                                                <button id="btnAddClient" name="btnAddClient" type="submit" class="btn btn-sm btn-success" value="AddClient">Submit</button>
                                            </form>
                                        </div>
                                    </section>
                                </div>
                            ...
                            <section class="panel panel-success">
                                <header class="panel-heading">Clients <i class="fa fa-info-sign text-muted" data-toggle="tooltip" data-placement="bottom" data-title="ajax to load the data."></i>
                                </header>
                                    ...
                                    <table class="table table-striped m-b-none" data-ride="datatables">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><form method="POST" action="clients.php"><input type="hidden" value="<?php echo $row["User_ID"]; ?>" name="userid"><input type="hidden" value="<?php echo $row["User_Name"]; ?>" name="username"><input type="hidden" value="<?php echo $row["User_Email"]; ?>" name="useremail"> <input id="delete" type="submit" name="delete" value="delete" class="btn btn-sm btn-danger"></form></td>
                                            </tr>
