                ...
                <section id="content">
                    <section class="vbox">
                        <section class="scrollable padder">
                            <div class="m-b-md">
                                <h3 class="m-b-none">Tips Subscribers</h3>
                            </div>
                            <section class="panel panel-success">
                                <header class="panel-heading">Tips Subscribers <i class="fa fa-info-sign text-muted" data-toggle="tooltip" data-placement="bottom" data-title="ajax to load the data."></i>
                                </header>
                                <div class="table-responsive">
                                    <table class="table table-striped m-b-none" data-ride="datatables">
                                        ...
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM `subscribefortips`";
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $row["SubscribeForTips_ID"]; ?></td>
                                                <td><?php echo $row["SubscribeForTips_Email"]; ?></td>
                                                <td><?php echo $row["SubscribeForTips_Status"]; ?></td>
                                                <td><?php echo date('D, d M Y',strtotime($row["SubscribeForTips_Date"])); ?></td>
                                            </tr>
